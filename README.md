...
- Gestión de contratos (inicio, duración y vencimiento)
- Liberación automática de jugadores cuando el contrato expira

## Cómo usarlo
1. Clonar o descargar el repositorio
2. Abrir el proyecto en NetBeans u otro IDE compatible con Java
